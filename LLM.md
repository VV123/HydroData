...
- data -> [MultiCoNER Datasets](https://registry.opendata.aws/multiconer/) paper -> [MultiCoNER: A Large-scale Multilingual Dataset for Complex Named Entity Recognition](https://arxiv.org/abs/2208.14536)

- data -> [Common Crawl dataset](https://commoncrawl.org) paper -> [Extracting Training Data from Large Language Models](https://arxiv.org/abs/2012.07805)
...
- data -> [generative-negative-mining-dataset](https://huggingface.co/datasets/ugursahin/generative-negative-mining-dataset) paper -> [Enhancing Multimodal Compositional Reasoning of Visual Language Models with Generative Negative Mining](https://arxiv.org/abs/2311.03964)
